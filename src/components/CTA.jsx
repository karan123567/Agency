...
export default function CTA() {
  ...
  useEffect(() => {
    if (!ref.current) return;
    gsap.fromTo(
      ref.current.querySelector(".cta-h"),
      { opacity: 0, y: 80 },
      {
        opacity: 1,
        y: 0,
  ...
  return (
    <>
      <style>{`
        .cta-section {
          background: rgba(4, 1, 14, 0.90);  /* dark enough to read, light enough to feel cosmic */
      ...
      <section id="cta" ref={ref} className="cta-section">
        ...
        <div className="cta-inner">
          ...
          <a
            href="mailto:rohit@astraforge.cloud"
            className="cta-email"
            onMouseEnter={(e) => (e.currentTarget.style.color = "#f5c842")}
            onMouseLeave={(e) => (e.currentTarget.style.color = "#5a5280")}
          >
