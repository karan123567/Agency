...
//     el.style.background = 'rgba(20,5,40,0.75)'
...
//   const handleLeave = e => {
//     const el = e.currentTarget
//     el.style.background = 'rgba(4,1,14,0.55)'
...
const SERVICES = [
  {
    ...
    desc: "We build fast, responsive, conversion-focused digital products engineered for modern businesses.",
  },
  {
    num: "02",
    icon: "◈",
    title: "UI/UX &\nDesign Systems",
    tags: ["Logo", "Typography", "Systems"],
    desc: "Interfaces designed for clarity, usability, and premium customer experience.",
  },
  {
    num: "03",
    icon: "⟁",
    title: "Interactive \n3D Experiences",
    tags: ["GSAP", "R3F", "Lottie", "Framer"],
    desc: "Immersive interactions powered by modern frontend engineering.",
  },
  {
    num: "04",
    icon: "⊛",
    title: "E-Commerce &\nSAAS Platforms",
    tags: ["Shopify", "Stripe", "CMS", "API"],
    desc: "Revenue-generating platforms built for growth, performance, and scale.",
  },
];
...
export default function Services() {
  ...
  const handleEnter = (e) => {
    const el = e.currentTarget;
    el.style.background = "rgba(20,5,40,0.35)";
    el.querySelector(".sarr").style.transform = "rotate(45deg)";
    el.querySelector(".sarr").style.borderColor = "#f5c842";
    el.querySelector(".sarr").style.color = "#f5c842";
  };
